...
import { LeadForm } from './form'; // <--- IMPORTANTE: Importando o componente funcional
import { 
  CheckCircle2, 
  Rocket, 
  Users, 
...
export default function PrimeiroEmpregoLanding() {
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 selection:bg-emerald-500/30">
      ...
      <nav className="border-b border-neutral-800 bg-neutral-950/50 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight">VaultMind<span className="text-emerald-500">OS</span></span>
          </div>
          <Link href="/login" className="bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 text-white px-5 py-2 rounded-full text-sm font-medium transition-all">
            Já sou Aluno
          </Link>
        </div>
      </nav>
      ...
      <header className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-col items-center gap-6 w-full max-w-md">
            {/* AQUI ESTÁ A MÁGICA: O FORMULÁRIO REAL */}
            <LeadForm />
      ...
      {/* Footer */}
      <footer className="py-12 px-4 border-t border-neutral-900 bg-neutral-950">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-neutral-600">
          <p>© 2026 VaultMindOS. Desenvolvido para transformar potencial em prontidão técnica.</p>
          <div className="flex items-center gap-6">
             <span className="hover:text-emerald-500 cursor-pointer transition-colors">Política de Privacidade</span>
